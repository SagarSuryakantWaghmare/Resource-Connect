                ...
                <div className='flex  justify-between'>
                    <div className='ml-5'>
                        ...
                        <div className='flex justify-center items-center'>
                         <button className='h-[35px] w-[85px] flex items-center justify-center rounded-lg bg-btnColor text-white mt-2 '>Invoice<i className="fa-solid fa-download text-sm ml-2"></i></button>
                    ...
                    <div className='mt-2 mr-7'>
                        ...
                        <h1 className='font-semibold'>Total Charges : <span className='font-bold'>Rs. 3500</span></h1>
